...
namespace OCMS_Services.Middleware
{
    ...
    public class StatusCheckBackgroundService : BackgroundService
    {
            ...
            TimeSpan? checkInterval = null)
        {
            ...
            _logger = logger;
            _checkInterval = checkInterval ?? TimeSpan.FromMinutes(1); // Mặc định chạy mỗi giờ
        }
        ...
        private DateTime CalculateNextRunTime(bool includeToday = true)
        {
            ...
            // Nếu interval là 1 phút, chạy mỗi phút một lần
            if (_checkInterval.TotalMinutes == 1)
            {
                // Đơn giản thêm 1 phút vào thời gian hiện tại
