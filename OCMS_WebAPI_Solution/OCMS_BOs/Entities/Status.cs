...
namespace OCMS_BOs.Entities
{
    ...
    {
        NewPlan = 0, NewCourse =1, UpdateCourse=2,DeleteCourse = 18,Complaint = 3, PlanChange = 4, PlanDelete = 5, CreateNew = 6, CreateRecurrent = 7, CreateRelearn = 8, CandidateImport = 9, Update = 10, Delete = 11, AssignTrainee = 12, AddTraineeAssign = 13, CertificateTemplate = 14, DecisionTemplate = 15, SignRequest = 16, Revoke =17
    }
